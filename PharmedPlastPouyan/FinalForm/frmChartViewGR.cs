...
{
    public partial class frmChartViewGR : Form
    {
        public frmChartViewGR()
        {
            FirstRun = true;
            InitializeComponent();
        }
        ...
        {
            comTitle.DataSource = Data.Select("select * from ChartTitleGR where ParentID=1 order by Tartib ASC");
            FirstRun = false;
        ...
        {
            DataTable DT1;
            DT1 = ChartData(Data.SelectOneCol("ChartTitleGR", "ID", strlist, "Result"), Data.SelectOneCol("ChartTitleGR", "ID", strlist, "TypeResult"), SplitTime, send, temp);
            ...
            if (DT1.TableName == "Line")
            {
                ...
                else
                {
                    ...
                    ChartView1.Legends[0].Font = new System.Drawing.Font("Microsoft Sans Serif", 15F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(178)));
                ...
                for (int i = 0; i < send; i++)
                {
                    ...
                    ChartView1.Series[i].Font = new System.Drawing.Font("Microsoft Sans Serif", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(178)));
                }
            }
            else
            {
        ...
        {
            DataTable DT2;
            DT2 = ChartData(Data.SelectOneCol("ChartTitleGR", "ID", strlist, "Result"), Data.SelectOneCol("ChartTitleGR", "ID", strlist, "TypeResult"), SplitTime, send, temp);
            ...
            if (DT2.TableName == "Line")
            {
                ...
                else
                {
                    ...
                    ChartView2.Legends[0].Font = new System.Drawing.Font("Microsoft Sans Serif", 15F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(178)));
                ...
                for (int i = 0; i < send; i++)
                {
                    ...
                    ChartView2.Series[i].Font = new System.Drawing.Font("Microsoft Sans Serif", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(178)));
        ...
        {
            DataTable DT3;
            DT3 = ChartData(Data.SelectOneCol("ChartTitleGR", "ID", strlist, "Result"), Data.SelectOneCol("ChartTitleGR", "ID", strlist, "TypeResult"), SplitTime, send, temp);
            ...
            if (DT3.TableName == "Line")
            {
                ...
                else
                {
                    ...
                    ChartView3.Legends[0].Font = new System.Drawing.Font("Microsoft Sans Serif", 15F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(178)));
                ...
                for (int i = 0; i < send; i++)
                {
                    ...
                    ChartView3.Series[i].Font = new System.Drawing.Font("Microsoft Sans Serif", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(178)));
        ...
        {
            DataTable DT4;
            DT4 = ChartData(Data.SelectOneCol("ChartTitleGR", "ID", strlist, "Result"), Data.SelectOneCol("ChartTitleGR", "ID", strlist, "TypeResult"), SplitTime, send, temp);
            ...
            if (DT4.TableName == "Line")
            {
                ...
                else
                {
                    ...
                    ChartView4.Legends[0].Font = new System.Drawing.Font("Microsoft Sans Serif", 15F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(178)));
                ...
                for (int i = 0; i < send; i++)
                {
                    ...
                    ChartView4.Series[i].Font = new System.Drawing.Font("Microsoft Sans Serif", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(178)));
        ...
        {
            DataTable dt = Data.Select("select * from ChartTitleGR where ParentID=" + comTitle.SelectedValue + " order by Tartib ASC");
        ...
        private void comchart_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if ((int)a["ParentID"] == 3)
            {
                ...
                comStop.DataSource = Data.Select("select * from ChartTitleGR where ParentID=" + comchart.SelectedValue + " order by Tartib ASC");
        ...
        private void FilterChart()
        {
            ...
            Sql = "select * from GranuleData {0}";
            Sql = string.Format(Sql, SqlWhere);
            DataAll = Data.Select(Sql);
            Sql = "select GranuleData.Day,GranuleData.Month,GranuleData.ProdectionCode,GranuleData.WeekNum,GranuleStop.IDGranule,StopType.Title,GranuleStop.StopID,GranuleStop.StopTime,GranuleDescription.Description FROM GranuleData ,GranuleStop,GranuleDescription,StopType {0} and GranuleStop.IDGranule= GranuleData.ID and GranuleDescription.IDGranule = GranuleData.ID and StopType.StopID = GranuleStop.StopID";
            Sql = string.Format(Sql, SqlWhere);
            Sql = Sql.Replace(" order by LotNum", "");
            Sql += " order by GranuleData.ID";
        ...
        {
            return pnl1.Height + pnl3.Height + pnl4.Height + pnl5.Height;
        }
        //action
        ...
        private void TableView()
        {
            ...
            string mess = "مجموع گرانول تولید شده : {0} کیلوگرم -  مجموع ضایعات گرانول: {1} کیلوگرم -  مجموع گرانول تحت کنترل : {2} کیلوگرم";
            lblview.Text = string.Format(mess, DataAll.AsEnumerable().Sum(x => x.Field<decimal>("PartNum")).ToString("G22"),
                DataAll.AsEnumerable().Sum(x => x.Field<decimal>("WastageNum")).ToString("G22"),
                DataAll.AsEnumerable().Sum(x => x.Field<decimal>("ControlNum")).ToString("G22"));
        }
